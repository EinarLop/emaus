      ...
      {loginStatus ? (
        <>
          <div class="flex flex-col text-center w-full mb-4 px-8">
            ...
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Desde este panel se pueden administrar todas las acciones relacionadas con la parte administrativa del sitio web</p>
          </div>
