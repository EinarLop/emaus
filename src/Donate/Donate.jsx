        ...
        <>
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-5 mx-auto">
                    ...
                    <div class="flex lg:w-2/3 w-full  flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-center">

                        <button class="text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">Dona a través de Paypal </button>
                    </div>
                </div>
            </section>
