      ...
      <div class=" xl:w-1/4 md:w-1/2 p-0 sm:p-4 sm:py-4 py-4  max-w-sm ">
        <div class=" bg-gray-100 p-6 rounded-lg">
          ...
          <div class="flex justify-between">
            ...
            {
              favorite ? <button onClick={props.setFav} class="bg-yellow-500 w-12 focus:outline-none hover:bg-gray-500 text-white font-bold py-2 px-4 rounded mb-4">★</button>
          ...
          <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">{`${dd}   ${mm}   ${yyyy}`}</h3>
