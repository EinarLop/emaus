...
const BlogCardAdmin = (props) => {
  const { postId, title, content, image, posted, favorite } = props.postInfo;
        ...
        <div class=" bg-gray-100 p-6 rounded-lg">
          <div class="flex justify-between">
            <button
              ...
              class="focus:outline-none bg-red-500 w-12 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mb-4"
            >
              X
            </button>
            <button onClick={props.setFav} class={favButtonClass}>
              ★
            </button>
          </div>
