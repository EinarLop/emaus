                ...
                <div class=" -my-8 lg:mx-6 divide-gray-100 shadow-md border  bg-gray-100 
                 rounded-lg">
                    <div class="p-4 xl:p-8 flex flex-wrap md:flex-nowrap ">
                        ...
                        <div class=" max-w-xs w-full justify-center pt-2 pl-2 pr-2 h-3/4 md:p-4  flex flex-wrap  md:flex-nowrap">
                            <img alt="evento" class=" rounded  container " style={{ objectFit: 'cover' }} src={imageUrl} />
                        </div>
